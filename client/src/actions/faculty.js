...
export const getCourses = () => async (dispatch) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/faculty/courses`);
...
export const getAttendance = (course) => async (dispatch) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/faculty/students/${course}`);
...
export const getStudents = (year) => async (dispatch) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/faculty/students/${year}`);
  ...
  (year, roll, course) => async (dispatch) => {
    try {
      const res = await axios.get(
        `http://localhost:3000/api/faculty/attendance/${year}/${roll}/${course}`
      );
...
export const addPost = (formData) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(`http://localhost:3000/api/faculty/courses`, formData, config);
  ...
  async (dispatch) => {
    ...
    try {
      const res = await axios.put(
        `http://localhost:3000/api/faculty/attendance/${year}/${roll}/${course}/${date}`,
        formData,
        config
      );
      console.log("FIRING");
...
export const archive = (course, year) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `http://localhost:3000/api/faculty/archive/${course}/${year}`,
      config
    );
    console.log("FIRING");
    dispatch({
...
export const unarchive = (course, year) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `http://localhost:3000/api/faculty/unarchive/${course}/${year}`,
      config
    );
    console.log("FIRING");
    dispatch({
...
export const getComments = (course, year) => async (dispatch) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/faculty/chat/${course}/${year}`);
...
export const addComment = (formData, course, year) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `http://localhost:3000/api/faculty/chat/${course}/${year}`,
      formData,
      config
    );
    console.log("FIRING");
